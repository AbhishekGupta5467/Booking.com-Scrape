...
# Set the URL directly in the script
url = "https://www.booking.com/searchresults.html?ss=Borivali+%2C+Mumbai%2C+Maharashtra%2C+India&map=1&ssne=Nashville&ssne_untouched=Nashville&label=gen173nr-1FCAEoggI46AdIM1gEaGyIAQGYATG4ARfIAQzYAQHoAQH4AQKIAgGoAgO4Arrp5bMGwAIB0gIkNzI0MzQzZmYtMjcyMS00MTNhLWIyMmQtNmI4ZjczNzk3YzYx2AIF4AIB&aid=304142&lang=en-us&sb=1&src_elem=sb&src=index&dest_id=3605&dest_type=district&ac_position=1&ac_click_type=b&ac_langcode=en&ac_suggestion_list_length=3&search_selected=true&search_pageview_id=d23d5edd703202d1&ac_meta=GhBkMjNkNWVkZDcwMzIwMmQxIAEoATICZW46CWthbmRpdmFsaUAASgBQAA%3D%3D&checkin=2024-07-01&checkout=2024-07-02&group_adults=2&no_rooms=1&group_children=0#map_opened"

# Update this path with the correct path to chromedriver.exe
service = Service(executable_path='C:\\correct\\path\\to\\chromedriver.exe')
...
for index, property_ in enumerate(properties):
    ...
    data['Tax'].append(tax)
    data['Property Link'].append(property_id_link)
